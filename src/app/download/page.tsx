export const metadata = {
  title: "Mission 365 - Android Download",
  description: "Download the Mission 365 Android app directly.",
};
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: "32px" }}>
        ...
        <p style={{ color: "#10B981", fontSize: "1rem", margin: 0 }}>
          365 days of discipline and growth.
        </p>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%", maxWidth: "320px" }}>
        ...
        <a
          href="https://dzlmtvodpyhetvektfuo.supabase.co/storage/v1/object/public/apks/mission-365-release.apk"
          download="mission-365-release.apk"
          style={{
            background: "#10B981",
            color: "#080604",
            padding: "18px 32px",
      ...
      <p style={{ marginTop: "48px", color: "rgba(245,240,232,0.25)", fontSize: "0.75rem" }}>
        The Kollective Hospitality Group · mission-365.vercel.app
      </p>
    </div>
  );
}
